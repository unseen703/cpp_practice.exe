...
sort(all(v));
    ...
    //  WE have two choose two children such that their collected weight is <=x ;
    // we can choose one children and search for other one whose weight <= x- wt1 && its not used previously
vi vis(n,0);
int en = n-1;
// int cnt =0;
rep( st, 0 ,n){

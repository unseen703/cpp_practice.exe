...
void DKK()
 { 
    ...
    if(m == 0){
       ...
       double mx = max((1.000 + double(sqrt(1.000 + 8*m)))/2.000 , (1.000 - double(sqrt(1.000 + 8*m)))/2.000);
        ll mn = (m<=(n+1)/2)?(n- 2*m):0;
        cout<< max(mn,0LL)<<" "<<max(0, (int)floor(n-mx))<<"\n";
    // if(m < (n+1)/2){
    //     cout<<n - 2*m<<" "<<n -(m+1)<<"\n";

    // }
    // else{
    // cout<<<<"  "<<(1.000 - double(sqrt(1.000 + 8*m)))/2.000<<"\n";
    // }
        // cout<<0 <<" "<<<<"\n";
    // else{
    //     cout<<0 <<" "<<n-(m+1)<<"\n";

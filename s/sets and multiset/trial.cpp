...
// needed to sort and operate on the the set of data

multiset<string> s; // log (n);
...
auto it = s.find(5)  ; // will return first 5 present 

// erase by reference   deletes the value correspondig to particular iterator
if(it != s.end()) s.erase(it);
// erase by value       deletes all element that are equal to value
 s.erase(5); // removes all 5
    return 0;
}
